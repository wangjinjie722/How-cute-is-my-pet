...
from resnet_model import ResNet_combined
...
#%%        
def img_64(EPOCH = 10, LR=0.001, Momentum=0.1, no_cuda=False, save_model=False):
...
#    test_img_path = "testdata_organized_hist/"
    ...
    model = ResNet_combined().to(device)
...
#    args = parser.parse_args()
    ...
    img_64(EPOCH = 10, LR=0.001, Momentum=0.1, no_cuda=False, save_model=False)